...
export function TopBar({ brand, title, favicon, center, right }: Props) {
  ...
  return (
    ...
    >
      <div className="mx-auto grid min-h-[68px] max-w-[1280px] grid-cols-[1fr_auto_1fr] items-center gap-4 px-5 py-3">
        <Link
          to="/"
          className="flex min-w-0 items-center gap-2.5 justify-self-start text-fg no-underline hover:text-fg"
        >
          <img
            src={logo}
            alt=""
